...
export const appConfig = {
  ...
  newsAI: {
    ...
    enableMock: process.env.OPENROUTER_ENABLE_MOCK !== 'false' || true,
    enableMockAds: process.env.OPENROUTER_ENABLE_MOCK_ADS === 'true' || false,
    enableMockTimeout: process.env.OPENROUTER_ENABLE_MOCK_TIMEOUT === 'true' || false,
