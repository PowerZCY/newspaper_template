...
export const NEWSPAPER_TEMPLATES = {
  ...
  song_cn: {
    ...
    defaultContent: {
      ...
      lyrics: '窗柩上的雨惹了谁的心&nbsp;风掠过檐角吹不散初影<div>砚台上的笔渐渐被唤醒&nbsp;墨迹挥毫却字字不语</div><div>那声叹息还在风里停<br>掌纹里的痕刻着谁的名&nbsp;烟花易冷后灯火也昏暝</div><div>故事里的景慢慢被擦去&nbsp;蓦然回首却步步无力</div><div>那段过往不愿再触及</div><div>雨落的声音动了谁的情&nbsp;往事如烟悄然复凌<br>时而绵密沾湿了衣襟&nbsp;将我带入那茫茫的追忆<br>时而骤急敲打着孤寂&nbsp;把我困进这深深的泥泞<br>想质问天叩问地&nbsp;好一句云淡风轻<br>&nbsp; ·二零二五年十二月十八日凌晨 帝八哥</div>',
